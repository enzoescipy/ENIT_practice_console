...
namespace MainProject
{
    public class FunctionalPage
    {
        ...
        public void UserInfo()
        {
            ...
            var borrowState = libraryDB.log.UserBorrowedFind(currentLogInUser.primaryKey);
            if (borrowState != null)
            {
            ...
            while (true)
            {
                ...
                else if (String.Equals("1", get))
                {
                    ...
                    int state = libraryDB.user.UserEmailChange(currentLogInUser.primaryKey, email);
                    if (state != 0)
                    {
                ...
                else if (String.Equals("2", get))
                {
                    ...
                    int state = libraryDB.user.UserPasswordChange(currentLogInUser.primaryKey, password_verify, password);
                    if (state == 0)
                    {
        ...
        public void UserBorrow()
        {
            ...
            while (true)
            {
                ...
                var state = libraryDB.Borrow(currentLogInUser.primaryKey, name, amountParsed);
        ...
        public void UserReturn()
        {
            ...
            while (true)
            {
                ...
                var state = libraryDB.Return(currentLogInUser.primaryKey, name, amountParsed);
