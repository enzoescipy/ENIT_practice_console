namespace MainProject
{
    ...
    {   
        ...
        public UserVO? UserLogin(string id, string password)
        {
            ...
            var query = localDBmodel.Find("id", id, stringEquals);
        ...
        {
            // find user.
            List<UserVO> query = localDBmodel.Find("primaryKey", pKey, simpleEquals);
            if (query.Count == 0) { return -1; }
        ...
        {
            // find user.
            List<UserVO> query = localDBmodel.Find("email", email, simpleEquals);
            if (query.Count == 0) { return -1; }
